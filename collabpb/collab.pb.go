...
func (x *ClientMessage) GetAcknowledge() *Acknowledge {
	if x != nil {
		if x, ok := x.Body.(*ClientMessage_Acknowledge); ok {
...
type ClientMessage_Acknowledge struct {
	Acknowledge *Acknowledge `protobuf:"bytes,4,opt,name=acknowledge,proto3,oneof"`
}
...
func (*ClientMessage_Acknowledge) isClientMessage_Body() {}
...
func (x *Acknowledge) Reset() {
	*x = Acknowledge{}
	mi := &file_collab_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Acknowledge) Descriptor() ([]byte, []int) {
	return file_collab_proto_rawDescGZIP(), []int{6}
}

func (x *Acknowledge) GetVersion() []byte {
	if x != nil {
		return x.Version
	}
	return nil
...
const file_collab_proto_rawDesc = "" +
	"\n" +
	"\fcollab.proto\x12\tcollab.v1\"\xe6\x01\n" +
	"\rClientMessage\x12%\n" +
	"\x04join\x18\x01 \x01(\v2\x0f.collab.v1.JoinH\x00R\x04join\x127\n" +
	"\n" +
	"operations\x18\x02 \x01(\v2\x15.collab.v1.OperationsH\x00R\n" +
	"operations\x121\n" +
	"\bpresence\x18\x03 \x01(\v2\x13.collab.v1.PresenceH\x00R\bpresence\x12:\n" +
	"\vacknowledge\x18\x04 \x01(\v2\x16.collab.v1.AcknowledgeH\x00R\vacknowledgeB\x06\n" +
	"\x04body\"\xb3\x01\n" +
	"\rServerMessage\x12.\n" +
...
var file_collab_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_collab_proto_goTypes = []any{
	...
	(*Acknowledge)(nil),   // 6: collab.v1.Acknowledge
}
var file_collab_proto_depIdxs = []int32{
	...
	6, // 3: collab.v1.ClientMessage.acknowledge:type_name -> collab.v1.Acknowledge
	3, // 4: collab.v1.ServerMessage.welcome:type_name -> collab.v1.Welcome
	4, // 5: collab.v1.ServerMessage.operations:type_name -> collab.v1.Operations
	5, // 6: collab.v1.ServerMessage.presence:type_name -> collab.v1.Presence
	0, // 7: collab.v1.Collab.Session:input_type -> collab.v1.ClientMessage
	1, // 8: collab.v1.Collab.Session:output_type -> collab.v1.ServerMessage
